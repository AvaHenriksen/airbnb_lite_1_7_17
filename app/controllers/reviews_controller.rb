class ReviewsController < ApplicationController
  def index
    ...
    @reviews = @q.result(:distinct => true).includes(:listing, :guest).page(params[:page]).per(10)
  ...
  def create
    ...
    @review.guest_id = params[:guest_id]
    @review.accuracy = params[:accuracy]
    @review.communication = params[:communication]
    @review.cleanliness = params[:cleanliness]
    @review.location = params[:location]
    @review.check_in_15 = params[:check_in_15]
